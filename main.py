...
# This part is image labels setting start 
        ...
        img=img.resize((1766,130),Image.Resampling.LANCZOS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="Image Based Attendance System",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1566,height=45)

        # Create buttons below the section
        # -------------------------------------------------------------------------------------------------------------------
        # student button 1
        std_img_btn=Image.open(r"Images_GUI\student_and_education_logo_free_download_6820451.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Student Portal",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Users\user\Pictures\CP2 images\istockphoto-1184864153-612x612.jpg")
